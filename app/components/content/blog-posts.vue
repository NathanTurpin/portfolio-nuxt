...
const posts = computed(() => {
  ...
  for (const post of data.value) {
    const year = new Date(post.publishAt).getFullYear();
...
<style scoped>
.column {
  @apply flex items-center space-x-8 py-2  border-b border-gray-200 dark:border-gray-600;
}
</style>